...
PRODUCTS = [
    ...
    Product(id="prod-001", title="Neon Samurai Nightfall", artist="tokyo_drift_ink",
            category="t-shirts", price=28.99, marketplace="inkvault",
            tags=["neon", "samurai", "cyberpunk", "japanese"]),
    Product(id="prod-002", title="Aurora Borealis Fox", artist="nordic_palette",
            category="t-shirts", price=26.99, marketplace="printhive",
            tags=["aurora", "fox", "northern-lights", "nature"]),
    # ── Stickers ──
    Product(id="prod-003", title="Wanderlust Compass Rose", artist="atlas_creative",
            category="stickers", price=4.49, marketplace="printhive",
            tags=["travel", "compass", "adventure", "wanderlust"]),
    Product(id="prod-004", title="Desert Bloom Cactus", artist="arid_arts",
            category="stickers", price=3.99, marketplace="inkvault",
            tags=["cactus", "desert", "bloom", "southwest"]),
    # ── Mugs ──
    Product(id="prod-005", title="Espresso Yourself", artist="bean_scene_co",
            category="mugs", price=16.99, marketplace="inkvault",
            tags=["coffee", "pun", "morning", "barista"]),
    Product(id="prod-006", title="Ctrl+Z My Morning", artist="devloop_designs",
            category="mugs", price=15.49, marketplace="printhive",
            tags=["developer", "humor", "undo", "morning"]),
    # ── Wall Art ──
    Product(id="prod-007", title="Midnight Ocean Waves", artist="tidal_studio",
            category="wall-art", price=39.99, marketplace="printhive",
            tags=["ocean", "waves", "abstract", "blue"]),
    Product(id="prod-008", title="Tokyo Street Neon", artist="tokyo_drift_ink",
            category="wall-art", price=44.99, marketplace="inkvault",
            tags=["tokyo", "neon", "street", "night"]),
    # ── Phone Cases ──
    Product(id="prod-009", title="Lo-Fi Raccoon Chill", artist="pixel_critters",
            category="phone-cases", price=22.99, marketplace="inkvault",
            tags=["lofi", "raccoon", "chill", "aesthetic"]),
    Product(id="prod-010", title="Marble Rose Gold", artist="luxe_line",
            category="phone-cases", price=24.99, marketplace="printhive",
            tags=["marble", "rose-gold", "elegant", "minimal"]),
    # ── Hoodies ──
    Product(id="prod-011", title="Galactic Wolf Hoodie", artist="cosmic_threads",
            category="hoodies", price=49.99, marketplace="inkvault",
            tags=["wolf", "galaxy", "space", "streetwear"]),
    Product(id="prod-012", title="Mountain Sunrise Pullover", artist="alpine_ink",
            category="hoodies", price=45.99, marketplace="printhive",
            tags=["mountain", "sunrise", "outdoor", "cozy"]),
    # ── Notebooks / Stationery ──
    Product(id="prod-013", title="Monstera Leaf Blueprint", artist="verde_studio",
            category="notebooks", price=14.49, marketplace="printhive",
            tags=["botanical", "monstera", "blueprint", "plant"]),
    Product(id="prod-014", title="Grid Paper Rebellion", artist="devloop_designs",
            category="notebooks", price=12.99, marketplace="inkvault",
            tags=["grid", "minimal", "engineering", "sketch"]),
    # ── Tote Bags ──
    Product(id="prod-015", title="Canvas Market Tote", artist="verde_studio",
            category="bags", price=19.99, marketplace="printhive",
            tags=["canvas", "market", "eco", "botanical"]),
    Product(id="prod-016", title="Graffiti Splash Bag", artist="urban_drip",
            category="bags", price=21.99, marketplace="inkvault",
            tags=["graffiti", "splash", "urban", "bold"]),
]
