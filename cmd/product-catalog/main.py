...
PRODUCTS = [
    Product(
        id="prod-001",
        title="Neon Samurai Nightfall",
        artist="tokyo_drift_ink",
        category="t-shirts",
        price=28.99,
        marketplace="inkvault",
        tags=["neon", "samurai", "cyberpunk", "japanese"],
    ),
    Product(
        id="prod-002",
        title="Wanderlust Compass Rose",
        artist="atlas_creative",
        category="stickers",
        price=4.49,
        marketplace="printhive",
        tags=["travel", "compass", "adventure", "wanderlust"],
    ),
    Product(
        id="prod-003",
        title="Espresso Yourself",
        artist="bean_scene_co",
        category="mugs",
        price=16.99,
        marketplace="inkvault",
    ...
    Product(
        id="prod-005",
        title="Lo-Fi Raccoon Chill",
        artist="pixel_critters",
    ...
    Product(
        id="prod-006",
        title="Aurora Borealis Fox",
        artist="nordic_palette",
        category="t-shirts",
        price=26.99,
        marketplace="printhive",
    ...
    Product(
        id="prod-007",
        title="Ctrl+Z My Morning",
        artist="devloop_designs",
        category="mugs",
        price=15.49,
        marketplace="inkvault",
